...
TEST(BST_Insert)
{
    ...
    BST<int> B;
    B.Insert(100).Insert(70).Insert(50).Insert(80).Insert(130).Insert(110).Insert(140);
    B.Insert(120).Insert(115).Insert(125).Insert(75).Insert(71).Insert(77);
...
TEST(BST_Search)
{
    ...
    BST<int> B;
    B.Insert(100).Insert(70).Insert(50).Insert(80).Insert(130).Insert(110);
